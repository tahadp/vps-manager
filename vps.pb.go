...
const file_vps_proto_rawDesc = "" +
	...
	"\x06vps_id\x18\x01 \x01(\tR\x05vpsId\"E\n" +
	...
	"\tHeartbeat\x12\x15.vps.HeartbeatRequest\x1a\x16.vps.HeartbeatResponse\x127\n" +
	"\n" +
	"RefreshNow\x12\x13.vps.RefreshRequest\x1a\x14.vps.RefreshResponse2\x9d\x02\n" +
	"\fAgentService\x12;\n" +
...
var file_vps_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_vps_proto_goTypes = []any{
	...
	(*RefreshRequest)(nil),     // 17: vps.RefreshRequest
	(*RefreshResponse)(nil),    // 18: vps.RefreshResponse
}
var file_vps_proto_depIdxs = []int32{
	...
	17, // 5: vps.BackendService.RefreshNow:input_type -> vps.RefreshRequest
	3,  // 6: vps.AgentService.ExecuteCommand:input_type -> vps.CommandRequest
	5,  // 7: vps.AgentService.ListDirectory:input_type -> vps.DirRequest
	8,  // 8: vps.AgentService.ReadFile:input_type -> vps.FileRequest
	10, // 9: vps.AgentService.WriteFile:input_type -> vps.WriteRequest
	2,  // 10: vps.AgentService.ShellStream:input_type -> vps.ShellMessage
	1,  // 11: vps.BackendService.StreamTelemetry:output_type -> vps.TelemetryResponse
	13, // 12: vps.BackendService.UploadScreenshot:output_type -> vps.ScreenshotResponse
	16, // 13: vps.BackendService.Heartbeat:output_type -> vps.HeartbeatResponse
	18, // 14: vps.BackendService.RefreshNow:output_type -> vps.RefreshResponse
	4,  // 15: vps.AgentService.ExecuteCommand:output_type -> vps.CommandResponse
	7,  // 16: vps.AgentService.ListDirectory:output_type -> vps.DirResponse
	9,  // 17: vps.AgentService.ReadFile:output_type -> vps.FileResponse
	11, // 18: vps.AgentService.WriteFile:output_type -> vps.WriteResponse
	2,  // 19: vps.AgentService.ShellStream:output_type -> vps.ShellMessage
