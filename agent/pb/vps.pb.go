...
const file_vps_proto_rawDesc = "" +
	...
	"\x10UploadScreenshot\x12\x16.vps.ScreenshotRequest\x1a\x17.vps.ScreenshotResponse2\x9d\x02\n" +
	"\fAgentService\x12;\n" +
...
var file_vps_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
...
var file_vps_proto_depIdxs = []int32{
	...
	3,  // 3: vps.AgentService.ExecuteCommand:input_type -> vps.CommandRequest
	5,  // 4: vps.AgentService.ListDirectory:input_type -> vps.DirRequest
	8,  // 5: vps.AgentService.ReadFile:input_type -> vps.FileRequest
	10, // 6: vps.AgentService.WriteFile:input_type -> vps.WriteRequest
	2,  // 7: vps.AgentService.ShellStream:input_type -> vps.ShellMessage
	1,  // 8: vps.BackendService.StreamTelemetry:output_type -> vps.TelemetryResponse
	13, // 9: vps.BackendService.UploadScreenshot:output_type -> vps.ScreenshotResponse
	4,  // 10: vps.AgentService.ExecuteCommand:output_type -> vps.CommandResponse
	7,  // 11: vps.AgentService.ListDirectory:output_type -> vps.DirResponse
	9,  // 12: vps.AgentService.ReadFile:output_type -> vps.FileResponse
	11, // 13: vps.AgentService.WriteFile:output_type -> vps.WriteResponse
	2,  // 14: vps.AgentService.ShellStream:output_type -> vps.ShellMessage
