  ...
  return (
    <aside className="glass-panel w-64 h-full flex flex-col justify-between p-4 flex-shrink-0">
      ...
      <div className="mt-auto">
        <button className="flex items-center gap-3 px-3 py-2 w-full rounded-lg text-sm font-medium text-text-secondary hover:text-status-error hover:bg-status-error/10 transition-colors">
